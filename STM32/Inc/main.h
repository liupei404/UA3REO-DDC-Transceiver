...
#define BUS_COMM_SDA_Pin GPIO_PIN_2
#define BUS_COMM_SDA_GPIO_Port GPIOA
#define BUS_COMM_SCK_Pin GPIO_PIN_3
#define BUS_COMM_SCK_GPIO_Port GPIOA
#define BUS_CS_Pin GPIO_PIN_4
#define BUS_CS_GPIO_Port GPIOA
#define BUS_SCK_Pin GPIO_PIN_5
#define BUS_SCK_GPIO_Port GPIOA
#define BUS_MISO_Pin GPIO_PIN_6
#define BUS_MISO_GPIO_Port GPIOA
#define BUS_MOSI_Pin GPIO_PIN_7
#define BUS_MOSI_GPIO_Port GPIOA
